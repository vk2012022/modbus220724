...
def update_labels():
    ...
    try:
        ...
        label_opening2.config(text=f"ОТКРЫТИЕ: {flags[8]}")
        label_closing2.config(text=f"ЗАКРЫТИЕ: {flags[9]}")
...
def update_button_colors():
    ...
    button_auto2.config(bg="green" if flags[5] else "red")
    button_open2.config(bg="green" if flags[6] else "red")
    button_close2.config(bg="green" if flags[7] else "red")
...
button_auto = tk.Button(label_frame1, text="АВТО", command=lambda: toggle_flag(0), bg="red", width=20, height=2)
button_auto.grid(row=0, column=0, columnspan=2, pady=5)

button_open = tk.Button(label_frame1, text="ОТКР", command=lambda: toggle_flag(1), bg="red", width=20, height=2)
button_open.grid(row=1, column=0, columnspan=2, pady=5)

button_close = tk.Button(label_frame1, text="ЗАКР", command=lambda: toggle_flag(2), bg="red", width=20, height=2)
button_close.grid(row=2, column=0, columnspan=2, pady=5)

label_opening = tk.Label(label_frame1, text="ОТКРЫТИЕ: False", font=("Arial", 12))
label_opening.grid(row=3, column=0, columnspan=2, pady=5)

label_closing = tk.Label(label_frame1, text="ЗАКРЫТИЕ: False", font=("Arial", 12))
label_closing.grid(row=4, column=0, columnspan=2, pady=5)

label_tx1 = tk.Label(label_frame1, text="T_X1:", font=("Arial", 12))
label_tx1.grid(row=5, column=0, pady=5, sticky="e")
label_tx1_value = tk.Label(label_frame1, text="0.0", font=("Arial", 12))
label_tx1_value.grid(row=5, column=1, pady=5, sticky="w")

label_ty1 = tk.Label(label_frame1, text="T_Y1:", font=("Arial", 12))
label_ty1.grid(row=6, column=0, pady=5, sticky="e")
label_ty1_value = tk.Label(label_frame1, text="0.0", font=("Arial", 12))
label_ty1_value.grid(row=6, column=1, pady=5, sticky="w")

label_tx2 = tk.Label(label_frame1, text="T_X2:", font=("Arial", 12))
label_tx2.grid(row=7, column=0, pady=5, sticky="e")
label_tx2_value = tk.Label(label_frame1, text="0.0", font=("Arial", 12))
label_tx2_value.grid(row=7, column=1, pady=5, sticky="w")

label_ty2 = tk.Label(label_frame1, text="T_Y2:", font=("Arial", 12))
label_ty2.grid(row=8, column=0, pady=5, sticky="e")
label_ty2_value = tk.Label(label_frame1, text="0.0", font=("Arial", 12))
label_ty2_value.grid(row=8, column=1, pady=5, sticky="w")

entry_tx1 = tk.Entry(label_frame1, font=("Arial", 12))
entry_tx1.grid(row=5, column=2, pady=5, padx=10)
entry_ty1 = tk.Entry(label_frame1, font=("Arial", 12))
entry_ty1.grid(row=6, column=2, pady=5, padx=10)
entry_tx2 = tk.Entry(label_frame1, font=("Arial", 12))
entry_tx2.grid(row=7, column=2, pady=5, padx=10)
entry_ty2 = tk.Entry(label_frame1, font=("Arial", 12))
entry_ty2.grid(row=8, column=2, pady=5, padx=10)

button_write = tk.Button(label_frame1, text="ЗАПИСАТЬ", command=write_input_values, bg="blue", fg="white", width=20,
                         height=2)
button_write.grid(row=9, column=0, columnspan=3, pady=5)
...
button_auto2 = tk.Button(label_frame2, text="АВТО", command=lambda: toggle_flag(5), bg="red", width=20, height=2)
button_auto2.grid(row=0, column=0, columnspan=2, pady=5)

button_open2 = tk.Button(label_frame2, text="ОТКР", command=lambda: toggle_flag(6), bg="red", width=20, height=2)
button_open2.grid(row=1, column=0, columnspan=2, pady=5)

button_close2 = tk.Button(label_frame2, text="ЗАКР", command=lambda: toggle_flag(7), bg="red", width=20, height=2)
button_close2.grid(row=2, column=0, columnspan=2, pady=5)

label_opening2 = tk.Label(label_frame2, text="ОТКРЫТИЕ: False", font=("Arial", 12))
label_opening2.grid(row=3, column=0, columnspan=2, pady=5)

label_closing2 = tk.Label(label_frame2, text="ЗАКРЫТИЕ: False", font=("Arial", 12))
label_closing2.grid(row=4, column=0, columnspan=2, pady=5)

label_tx1_2 = tk.Label(label_frame2, text="X1:", font=("Arial", 12))
label_tx1_2.grid(row=5, column=0, pady=5, sticky="e")
label_tx1_value2 = tk.Label(label_frame2, text="0.0", font=("Arial", 12))
label_tx1_value2.grid(row=5, column=1, pady=5, sticky="w")

label_ty1_2 = tk.Label(label_frame2, text="Y1:", font=("Arial", 12))
label_ty1_2.grid(row=6, column=0, pady=5, sticky="e")
label_ty1_value2 = tk.Label(label_frame2, text="0.0", font=("Arial", 12))
label_ty1_value2.grid(row=6, column=1, pady=5, sticky="w")

label_tx2_2 = tk.Label(label_frame2, text="X2:", font=("Arial", 12))
label_tx2_2.grid(row=7, column=0, pady=5, sticky="e")
label_tx2_value2 = tk.Label(label_frame2, text="0.0", font=("Arial", 12))
label_tx2_value2.grid(row=7, column=1, pady=5, sticky="w")

label_ty2_2 = tk.Label(label_frame2, text="Y2:", font=("Arial", 12))
label_ty2_2.grid(row=8, column=0, pady=5, sticky="e")
label_ty2_value2 = tk.Label(label_frame2, text="0.0", font=("Arial", 12))
label_ty2_value2.grid(row=8, column=1, pady=5, sticky="w")

entry_tx1_2 = tk.Entry(label_frame2, font=("Arial", 12))
entry_tx1_2.grid(row=5, column=2, pady=5, padx=10)
entry_ty1_2 = tk.Entry(label_frame2, font=("Arial", 12))
entry_ty1_2.grid(row=6, column=2, pady=5, padx=10)
entry_tx2_2 = tk.Entry(label_frame2, font=("Arial", 12))
entry_tx2_2.grid(row=7, column=2, pady=5, padx=10)
entry_ty2_2 = tk.Entry(label_frame2, font=("Arial", 12))
entry_ty2_2.grid(row=8, column=2, pady=5, padx=10)

button_write2 = tk.Button(label_frame2, text="ЗАПИСАТЬ", command=write_input_values2, bg="blue", fg="white", width=20,
                          height=2)
button_write2.grid(row=9, column=0, columnspan=3, pady=5)
