...
def read_register(client, address):
    ...
    if response:
        ...
        print(f"Ошибка чтения регистра по адресу {address}")
        return None
...
def write_register(client, address, value):
    ...
    if not success:
        print(f"Ошибка записи регистра по адресу {address}")
...
def read_flag(client, address):
    ...
    if response:
        ...
        print(f"Ошибка чтения флага по адресу {address}")
        return None
...
def write_flag(client, address, value):
    ...
    if not success:
        print(f"Ошибка записи флага по адресу {address}")
