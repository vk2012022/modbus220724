...
label_ki2 = tk.Label(label_frame2, text="КОЭФИЦИЕНТ И:", font=("Arial", 12))
...
label_kd2 = tk.Label(label_frame2, text="КОЭФИЦИЕНТ Д:", font=("Arial", 12))
...
button_external_sensor_record = tk.Button(label_frame_boiler, text="ЗАП РЕГ ВНЕШ ДАТЧИКОВ",
