...
button_correction_radiators_plus = tk.Button(label_frame1, text="КОРРЕКЦИЯ ПЛЮС", command=lambda: toggle_flag(12),
                                             bg="grey", width=20, height=2)
button_correction_radiators_plus.grid(row=8, column=0, columnspan=3, pady=5)

button_correction_radiators_minus = tk.Button(label_frame1, text="КОРРЕКЦИЯ МИНУС", command=lambda: toggle_flag(13),
                                              bg="grey", width=20, height=2)
...
button_correction_floor_plus = tk.Button(label_frame2, text="КОРРЕКЦИЯ ПЛЮС", command=lambda: toggle_flag(14),
                                         bg="grey", width=20, height=2)
button_correction_floor_plus.grid(row=8, column=0, columnspan=3, pady=5)

button_correction_floor_minus = tk.Button(label_frame2, text="КОРРЕКЦИЯ МИНУС", command=lambda: toggle_flag(15),
                                          bg="grey", width=20, height=2)
...
label_radiator_supply_sensor = tk.Label(label_frame_boiler, text="НАРУЖНЫЙ ДАТЧИК ПОДАЧИ РАДИАТОРОВ:",
                                        font=("Arial", 12))
...
label_floor_supply_sensor = tk.Label(label_frame_boiler, text="НАРУЖНЫЙ ДАТЧИК ПОДАЧИ ТЕПЛОГО ПОЛА:",
                                     font=("Arial", 12))
...
button_sensor_selection = tk.Button(label_frame_boiler, text="ВЫБОР ДАТЧИКОВ НА ДОМЕ 1 ИЛИ 2",
                                    command=lambda: toggle_flag(16), bg="grey", width=30, height=2)
button_sensor_selection.grid(row=10, column=0, pady=5)
label_sensor_selection = tk.Canvas(label_frame_boiler, width=40, height=40, bg="grey")
label_sensor_selection.grid(row=10, column=1, pady=5, padx=10)

button_external_sensor_activation = tk.Button(label_frame_boiler, text="ВКЛЮЧЕНИЕ ВНЕШНИХ ДАТЧИКОВ",
                                              command=lambda: toggle_flag(17), bg="grey", width=30, height=2)
button_external_sensor_activation.grid(row=11, column=0, pady=5)
label_external_sensor_activation = tk.Canvas(label_frame_boiler, width=40, height=40, bg="grey")
label_external_sensor_activation.grid(row=11, column=1, pady=5, padx=10)

button_external_sensor_record = tk.Button(label_frame_boiler, text="ЗАПИСЬ РЕГИСТРОВ ВНЕШНИХ ДАТЧИКОВ ТЕМП",
                                          command=lambda: toggle_flag(18), bg="grey", width=30, height=2)
button_external_sensor_record.grid(row=12, column=0, pady=5)
label_external_sensor_record = tk.Canvas(label_frame_boiler, width=40, height=40, bg="grey")
label_external_sensor_record.grid(row=12, column=1, pady=5, padx=10)
